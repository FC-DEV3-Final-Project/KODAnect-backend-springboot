...
public class MemorialHtmlNormalizer {
    ...
    private static final String TEMPLATE = """
            <p>기증자 %s (%s, %s) 님은 %s 환자들에게 귀중한 장기를 선물해 주셨습니다.</p><p>한국장기조직기증원은 귀한 생명을 나눠주신 기증자와 유가족께 깊이 감사드리며,<br />앞으로도 기증자 유가족들이 건강한 삶을 유지할 수 있도록 최선을 다해 지원할 것입니다.</p><p>고인의 명복을 빕니다.</p>""";
